 ...
 */
public class GesturePwdLoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grsturepwd_login);
        ButterKnife.bind(this);
        this.init();
    }

    private void init() {
        aCache = ACache.get(GesturePwdLoginActivity.this);
        //得到当前用户的手势密码
    ...
    private void loginGestureSuccess() {
        Intent intent = new Intent(GesturePwdLoginActivity.this, MainActivity.class);
