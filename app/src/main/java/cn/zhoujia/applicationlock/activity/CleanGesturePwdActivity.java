 ...
 */
public class CleanGesturePwdActivity extends Activity {
    @Bind(R.id.messageTv)
    TextView messageTv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clean_gesturepwd);
        ButterKnife.bind(this);
        this.init();
    }

    private void init() {
        aCache = ACache.get(CleanGesturePwdActivity.this);
        //得到当前用户的手势密码
    ...
    private void loginGestureSuccess() {
        aCache.clear();
        Toast.makeText(this, "手势密码清除成功", Toast.LENGTH_SHORT).show();
        finish();
    }
